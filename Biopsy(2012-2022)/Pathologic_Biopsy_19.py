...
class Pathologic_Biopsy19(BaseETL):
    ...
    def run(self):
        ...
        f = open('Biopsy(2012-2022)/Pathologic_Biopsy_19(Inspection_Items).sql', 'rt', encoding = 'UTF8')
        ...
        df.to_excel('D:/Gastric_Cancer_xlsx/Biopsy(2012-2022)/Pathologic_Biopsy_19(Inspection Items).xlsx')
