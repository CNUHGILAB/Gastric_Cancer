...
class NEWEndoscopeStep83(BaseETL):
    ...
    def run(
        ...
        df = pd.DataFrame()
        o_ID= [
                "E7630B:166937746329555011244100912248486105249",
        ...
        print(df)
        self.insert(df, db_name="gc_protocol", tb_name="newendoscopestep83") 
        

if __name__ == "__main__":
    obj = NEWEndoscopeStep83()
    obj.run()