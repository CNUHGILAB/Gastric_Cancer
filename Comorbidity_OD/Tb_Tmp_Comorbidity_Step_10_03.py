...
class TbTmpComorbidityStep10_03(BaseETL):
    ...
    def run(
        ...
        SELECT
            ...
            st1.MI
        FROM
            gc_protocol.tb_tmp_comorbidity_step_10_00 st0
            LEFT JOIN gc_protocol.tb_tmp_comorbidity_step_10_01 st1 ON st0.ID = st1.ID
            OR (
        ...
        FROM
            gc_protocol.tb_tmp_comorbidity_step_10_00 st0
            RIGHT JOIN gc_protocol.tb_tmp_comorbidity_step_10_01 st1 ON st0.ID = st1.ID
            OR (
                st0.Angina_Date = st1.MI_Date
                AND st0.Angina_MD_1 = st1.MI_MD_1
                AND st0.Angina_MD_2 = st1.MI_MD_2
        ...
        FROM
            gc_protocol.tb_tmp_comorbidity_step_10_00 st0
            INNER JOIN gc_protocol.tb_tmp_comorbidity_step_10_01 st1 ON st0.ID = st1.ID
            OR (
                st0.Angina_Date = st1.MI_Date
                AND st0.Angina_MD_1 = st1.MI_MD_1
                AND st0.Angina_MD_2 = st1.MI_MD_2
        ...
        print(df)
        self.insert(df, db_name="gc_protocol", tb_name="tb_tmp_comorbidity_step_10_03")
