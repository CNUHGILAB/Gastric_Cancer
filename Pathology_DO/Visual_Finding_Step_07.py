...
class VisualFindingStep07(BaseETL):
    ...
    def run(
        ...
        sql = "SELECT 환자번호 AS ID, 원무접수ID AS CHKID,  검사시행일 AS Date, 육안소견, 판독의, Tumor_size1, Tumor_size2 FROM visual_findings_step06 ORDER BY 환자번호,검사시행일"
        ...
        self.insert(final, db_name="gc_protocol", tb_name="visual_findings_step07") 
