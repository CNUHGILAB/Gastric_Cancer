...
class Comorbidity04_01(BaseETL):
    ...
    def run(self):
        ...
        for x in o_ID:
            ...
            f = open("Comorbidity(2012-2022)/Comorbidity_04_01(HTN).txt", 'rt', encoding = 'UTF8')
        ...
        df.to_excel('D:/Gastric_Cancer_xlsx/Comorbidity(2012-2022)/Comorbidity_04_01(HTN).xlsx')
        
        self.insert(df, db_name = "comorbidity_protocol", tb_name = "comorbidity_04_01") #tb_name = "tb_tmp_comorbidity_step_04"
