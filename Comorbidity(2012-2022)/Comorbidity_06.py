...
class Comorbidity06(BaseETL):
    ...
    def run(self):
        ...
        for x in o_ID:
            ...
            f = open("Comorbidity(2012-2022)/Comorbidity_06(L_Hep).txt", 'rt', encoding = 'UTF8')
        ...
        self.insert(df, db_name = "comorbidity_protocol", tb_name = "comorbidity_06") # tb_name = "tb_tmp_comorbidity_step_06"
