...
class OpRecord03(BaseETL):
    ...
    def run(self):
        ...
        for x in one:
            ...
            f = open("Operation_Record(Total)/Operation_Record_03.sql", 'rt', encoding = 'UTF8')
            ...
            df.to_excel('D:/Gastric_Cancer_xlsx/Operation_Record(Total)/Operation_Record_03.xlsx')
            
        self.insert(df, db_name = "operation_record_total", tb_name = "operation_record_03") 
