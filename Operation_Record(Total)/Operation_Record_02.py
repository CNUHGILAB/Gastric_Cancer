...
class OpRecord02(BaseETL):
    ...
    def run(self):
        ...
        for i, j, k, l in zip(one, two, three, four):
            ...
            f = open("Operation_Record(Total)/Operation_Record_02.sql", 'rt', encoding = 'UTF8')
            ...
            df.to_excel('D:/Gastric_Cancer_xlsx/Operation_Record(Total)/Operation_Record_02.xlsx')
            
        self.insert(df, db_name = "operation_record_total", tb_name = "operation_record_02") 
