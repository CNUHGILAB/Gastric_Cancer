...
class OpRecord01(BaseETL):
    ...
    def run(self):
        ...
        for x, y in zip(one, two):
            ...
            f = open("Operation_Record(Total)/Operation_Record_01.sql", 'rt', encoding = 'UTF8')
            ...
            df.to_excel('D:/Gastric_Cancer_xlsx/Operation_Record(Total)/Operation_Record_01.xlsx')
            
        self.insert(df, db_name = "operation_record_total", tb_name = "operation_record_01") 
