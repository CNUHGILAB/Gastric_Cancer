...
class Pathologic_Biopsy13(BaseETL):
    ...
    def run(self):
        ...
        f = open('Biopsy(Total)/Pathologic_Biopsy_13(Clear_Resection_Margin).sql', 'rt', encoding = 'UTF8')
        ...
        df.to_excel('D:/Gastric_Cancer_xlsx/Biopsy(Total)/Pathologic_Biopsy_13(Clear Resection Margin).xlsx')
