...
class Pathologic_Biopsy08(BaseETL):
    ...
    def run(self):
        ...
        f = open("Biopsy(Total)/Pathologic_Biopsy_08(Histologic_Type_1).sql", 'rt', encoding = 'UTF8')
        ...
        df.to_excel('D:/Gastric_Cancer_xlsx/Biopsy(Total)/Pathologic_Biopsy_08(Histologic Type1).xlsx')
