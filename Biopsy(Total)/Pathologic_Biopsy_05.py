...
class Pathologic_Biopsy05(BaseETL):
    ...
    def run(self):
        ...
        f = open('Biopsy(Total)/Pathologic_Biopsy_05(Lauren_Type).sql', 'rt', encoding='UTF8')
        ...
        df.to_excel('D:/Gastric_Cancer_xlsx/Biopsy(Total)/Pathologic_Biopsy_05(Lauren Type).xlsx')
