...
FROM(
    ...
    FROM(
        SELECT *,
            ...
            END AS PA3_1,
            CASE
                WHEN (NULLIF(PA3_2_1, '') IS NOT NULL AND NULLIF(PA3_2_1_1, '') IS NULL AND NULLIF(PA3_2_1_2, '') IS NULL AND NULLIF(PA3_2_1_3, '') IS NULL AND NULLIF(PA3_2_1_4, '') IS NULL)
                THEN PA3_2_1
                WHEN (NULLIF(PA3_2_1, '') IS NOT NULL AND NULLIF(PA3_2_1_1, '') IS NOT NULL AND NULLIF(PA3_2_1_2, '') IS NULL AND NULLIF(PA3_2_1_3, '') IS NULL AND NULLIF(PA3_2_1_4, '') IS NULL)
                THEN PA3_2_1_1
                WHEN (NULLIF(PA3_2_1, '') IS NOT NULL AND NULLIF(PA3_2_1_1, '') IS NOT NULL AND NULLIF(PA3_2_1_2, '') IS NOT NULL AND NULLIF(PA3_2_1_3, '') IS NULL AND NULLIF(PA3_2_1_4, '') IS NULL)
                THEN PA3_2_1_2
                WHEN (NULLIF(PA3_2_1, '') IS NOT NULL AND NULLIF(PA3_2_1_1, '') IS NOT NULL AND NULLIF(PA3_2_1_2, '') IS NOT NULL AND NULLIF(PA3_2_1_3, '') IS NOT NULL AND NULLIF(PA3_2_1_4, '') IS NULL)
                THEN PA3_2_1_3
                WHEN (NULLIF(PA3_2_1, '') IS NOT NULL AND NULLIF(PA3_2_1_1, '') IS NOT NULL AND NULLIF(PA3_2_1_2, '') IS NOT NULL AND NULLIF(PA3_2_1_3, '') IS NOT NULL AND NULLIF(PA3_2_1_4, '') IS NOT NULL)
                THEN PA3_2_1_4
                WHEN (NULLIF(PA3_2_2, '') IS NOT NULL AND NULLIF(PA3_2_2_1, '') IS NULL AND NULLIF(PA3_2_2_2, '') IS NULL AND NULLIF(PA3_2_2_3, '') IS NULL AND NULLIF(PA3_2_2_4, '') IS NULL)
                THEN PA3_2_2
                WHEN (NULLIF(PA3_2_2, '') IS NOT NULL AND NULLIF(PA3_2_2_1, '') IS NOT NULL AND NULLIF(PA3_2_2_2, '') IS NULL AND NULLIF(PA3_2_2_3, '') IS NULL AND NULLIF(PA3_2_2_4, '') IS NULL)
                THEN PA3_2_2_1
                WHEN (NULLIF(PA3_2_2, '') IS NOT NULL AND NULLIF(PA3_2_2_1, '') IS NOT NULL AND NULLIF(PA3_2_2_2, '') IS NOT NULL AND NULLIF(PA3_2_2_3, '') IS NULL AND NULLIF(PA3_2_2_4, '') IS NULL)
                THEN PA3_2_2_2
                WHEN (NULLIF(PA3_2_2, '') IS NOT NULL AND NULLIF(PA3_2_2_1, '') IS NOT NULL AND NULLIF(PA3_2_2_2, '') IS NOT NULL AND NULLIF(PA3_2_2_3, '') IS NOT NULL AND NULLIF(PA3_2_2_4, '') IS NULL)
                THEN PA3_2_2_3
                WHEN (NULLIF(PA3_2_2, '') IS NOT NULL AND NULLIF(PA3_2_2_1, '') IS NOT NULL AND NULLIF(PA3_2_2_2, '') IS NOT NULL AND NULLIF(PA3_2_2_3, '') IS NOT NULL AND NULLIF(PA3_2_2_4, '') IS NOT NULL)
                THEN PA3_2_2_4
                ELSE NULL
            END AS PA3_2,
            CASE
        ...
        FROM(
            SELECT *,
                ...
                CASE
                    ...
                    THEN E_PA3_2_1
                    WHEN (NULLIF(E_PA3_2_2, '') IS NOT NULL)
                    THEN E_PA3_2_2
                    ELSE NULL
                END AS E_PA3_2,
                CASE
            ...
            FROM(
                SELECT *,
                    ...
                    END AS PA3_1_2_4,
                    CASE
                        WHEN (NULLIF(PA3_2_1_3, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 6), '^[0-9]{1,3}') != 0)
                        THEN CONCAT(
                            CONCAT(
                                PA3_2_1_3, ';'
                            ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 6)
                        )
                        WHEN (NULLIF(PA3_2_1_3, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 6), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                        THEN CONCAT(
                            CONCAT(
                                PA3_2_1_3, ';'
                            ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 6)
                    ...
                    END AS PA3_2_1_4,
                    CASE
                        WHEN (NULLIF(PA3_2_2_3, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 7), '^[0-9]{1,3}') != 0)
                        THEN CONCAT(
                            CONCAT(
                                PA3_2_2_3, ';'
                            ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 7)
                        )
                        WHEN (NULLIF(PA3_2_2_3, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 7), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                        THEN CONCAT(
                            CONCAT(
                                PA3_2_2_3, ';'
                            ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 7)
                ...
                FROM(
                    SELECT *,
                        ...
                        END AS PA3_1_2_3,
                        CASE
                            WHEN (NULLIF(PA3_2_1_2, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 5), '^[0-9]{1,3}') != 0)
                            THEN CONCAT(
                                CONCAT(
                                    PA3_2_1_2, ';'
                                ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 5)
                            )
                            WHEN (NULLIF(PA3_2_1_2, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 5), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                            THEN CONCAT(
                                CONCAT(
                                    PA3_2_1_2, ';'
                                ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 5)
                        ...
                        END AS PA3_2_1_3,
                        CASE
                            WHEN (NULLIF(PA3_2_2_2, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 6), '^[0-9]{1,3}') != 0)
                            THEN CONCAT(
                                CONCAT(
                                    PA3_2_2_2, ';'
                                ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 6)
                            )
                            WHEN (NULLIF(PA3_2_2_2, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 6), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                            THEN CONCAT(
                                CONCAT(
                                    PA3_2_2_2, ';'
                                ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 6)
                    ...
                    FROM(
                        SELECT *,
                            ...
                            END AS PA3_1_2_2,
                            CASE
                                WHEN (NULLIF(PA3_2_1_1, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 4), '^[0-9]{1,3}') != 0)
                                THEN CONCAT(
                                    CONCAT(
                                        PA3_2_1_1, ';'
                                    ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 4)
                                )
                                WHEN (NULLIF(PA3_2_1_1, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 4), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                THEN CONCAT(
                                    CONCAT(
                                        PA3_2_1_1, ';'
                                    ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 4)
                            ...
                            END AS PA3_2_1_2,
                            CASE
                                WHEN (NULLIF(PA3_2_2_1, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 5), '^[0-9]{1,3}') != 0)
                                THEN CONCAT(
                                    CONCAT(
                                        PA3_2_2_1, ';'
                                    ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 5)
                                )
                                WHEN (NULLIF(PA3_2_2_1, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 5), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                THEN CONCAT(
                                    CONCAT(
                                        PA3_2_2_1, ';'
                                    ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 5)
                        ...
                        FROM(
                            SELECT *,
                                ...
                                END AS PA3_1_2_1,
                                CASE
                                    WHEN (NULLIF(PA3_2_1, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 3), '^[0-9]{1,3}') != 0)
                                    THEN CONCAT(
                                        CONCAT(
                                            PA3_2_1, ';'
                                        ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 3)
                                    )
                                    WHEN (NULLIF(PA3_2_1, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                    THEN CONCAT(
                                        CONCAT(
                                            PA3_2_1, ';'
                                        ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 3)
                                ...
                                END AS PA3_2_1_1,
                                CASE
                                    WHEN (NULLIF(PA3_2_2, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 4), '^[0-9]{1,3}') != 0)
                                    THEN CONCAT(
                                        CONCAT(
                                            PA3_2_2, ';'
                                        ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 4)
                                    )
                                    WHEN (NULLIF(PA3_2_2, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 4), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                    THEN CONCAT(
                                        CONCAT(
                                            PA3_2_2, ';'
                                        ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 4)
                                ...
                                END AS SA3_1_1_1,
                                CASE
                                    WHEN (NULLIF(SA3_1_1, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_3, '[^;]+', 1, 4), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                    THEN CONCAT(
                                        CONCAT(
                                            SA3_1_1, ';'
                                        ), REGEXP_SUBSTR(SLIDE_KEYS_1_3, '[^;]+', 1, 4)
                            ...
                            FROM(
                                SELECT *,
                                    ...
                                    CASE
                                        WHEN (NULLIF(E_PA3_2_2, '') IS NOT NULL)
                                        THEN REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 3)
                                        ELSE NULL
                                    END AS PA3_2_2,
                                    CASE
                                        WHEN (NULLIF(E_SA3_1_1, '') IS NOT NULL)
                                ...
                                FROM(
                                    SELECT *,
                                        CASE
                                            WHEN (NULLIF(PARAFFIN_BLOCK_KEYS_1_3, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_1_3, '[^;]+', 1, 1), '[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_1_3, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_1_3, '[^;]+', 1, 1)
                                            ELSE NULL
                                        END AS E_PA3_1_1,
                                        CASE
                                            WHEN (NULLIF(PARAFFIN_BLOCK_KEYS_1_3, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_1_3, '[^;]+', 1, 1), '[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_1_3, '[^;]+', 1, 2), '[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_1_3, '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN CONCAT(
                                                CONCAT(
                                        ...
                                        END AS E_PA3_1_2,
                                        CASE
                                            WHEN (NULLIF(PARAFFIN_BLOCK_KEYS_2_3, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 1)
                                            WHEN (NULLIF(PARAFFIN_BLOCK_KEYS_2_3, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 1), '^[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 2), '^[0-9]{1,3}') != 0)
                                            THEN REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 1)
                                            ELSE NULL
                                        END AS E_PA3_2_1,
                                        CASE
                                            WHEN (NULLIF(PARAFFIN_BLOCK_KEYS_2_3, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN CONCAT(
                                                CONCAT(
                                                    REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 1), ';'
                                                ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 2)
                                            )
                                            WHEN (NULLIF(PARAFFIN_BLOCK_KEYS_2_3, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 1), '^[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 2), '^[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 3), '^[0-9]{1,3}') != 0)
                                            THEN CONCAT(
                                                CONCAT(
                                                    REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 1), ';'
                                                ), REGEXP_SUBSTR(PARAFFIN_BLOCK_KEYS_2_3, '[^;]+', 1, 2)
                                        ...
                                        END AS E_SA3_1_1,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_1_3, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_3, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(SLIDE_KEYS_1_3, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_3, '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN CONCAT(
                                                CONCAT(
                                    ...
                                    FROM(
                                        SELECT *,
                                            ...
                                            CASE
                                                WHEN (NULLIF(KEYS_A3, '') IS NOT NULL AND NULLIF(PARAFFIN_BLOCK_KEYS_2, '') IS NOT NULL)
                                                THEN KEYS_A3
                                                ELSE NULL
