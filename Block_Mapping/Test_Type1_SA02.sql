...
FROM(
    ...
    FROM(
        SELECT *,
            ...
            END AS SA2_1,
            CASE
                WHEN (NULLIF(SA2_4_1, '') IS NOT NULL)
                THEN SA2_4_1
                WHEN (NULLIF(SA2_4_2, '') IS NOT NULL)
                THEN SA2_4_2
                ELSE NULL
            END AS SA2_4
        FROM(
                        ...
                        FROM(
                            ...
                            FROM(
                                SELECT *,
                                    ...
                                    CASE
                                        WHEN (NULLIF(E_SA2_3, '') IS NOT NULL)
                                        THEN SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_2, '[^;]+', 1, 1), 1, INSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_2, '[^;]+', 1, 1), ')'))
                                        ELSE NULL
                                    END AS SA2_3,
                                    CASE
                                        WHEN (NULLIF(E_SA2_4_1, '') IS NOT NULL)
                                ...
                                FROM(
                                    SELECT *,
                                        ...
                                        END AS E_SA2_1_1,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_1_2, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_2, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_2, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_2, '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN CONCAT(
                                                CONCAT(
                                        ...
                                        END AS E_SA2_1_2,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_2_2, '') IS NOT NULL)
                                            THEN REGEXP_SUBSTR(SLIDE_KEYS_2_2, '[^;]+', 1, 2)
                                            ELSE NULL
                                        END AS E_SA2_2,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_3_2, '') IS NOT NULL AND NULLIF(REGEXP_SUBSTR(SLIDE_KEYS_3_2, '[^;]+', 1, 1), '') IS NOT NULL)
                                            THEN SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_2, '[^;]+', 1, 1), REGEXP_INSTR(BINARY REGEXP_SUBSTR(SLIDE_KEYS_3_2, '[^;]+', 1, 1), '[a-z]+'))
                                            ELSE NULL
                                        END AS E_SA2_3,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_4_2, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_2, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') != 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_2, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_2, '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN REGEXP_SUBSTR(SLIDE_KEYS_4_2, '[^;]+', 1, 2)
                                            ELSE NULL
                                        END AS E_SA2_4_1,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_4_2, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_2, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') != 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_2, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_2, '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_2, '[^;]+', 1, 4), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN CONCAT(
                                                CONCAT(
                                        ...
                                        END AS E_SA2_4_2,
                                        CASE
                                            WHEN (NULLIF(PARAFFIN_BLOCK_KEYS_1_2, '') IS NOT NULL)
                                    ...
                                    FROM(
                                        SELECT *,
                                            ...
                                            CASE
                                                WHEN (NULLIF(KEYS_A2, '') IS NOT NULL AND NULLIF(SLIDE_KEYS_2, '') IS NOT NULL)
                                                THEN KEYS_A2
                                                ELSE NULL
                                            END AS SLIDE_KEYS_2_2,
                                            CASE
                                                WHEN (NULLIF(KEYS_A2, '') IS NOT NULL AND NULLIF(SLIDE_KEYS_3, '') IS NOT NULL)
                                                THEN KEYS_A2
                                                ELSE NULL
                                            END AS SLIDE_KEYS_3_2,
                                            CASE
                                                WHEN (NULLIF(KEYS_A2, '') IS NOT NULL AND NULLIF(SLIDE_KEYS_4, '') IS NOT NULL)
                                                THEN KEYS_A2
                                                ELSE NULL
                                            ...
                                            FROM(
                                                SELECT *,
                                                    CASE
                                                        ...
                                                        THEN SUBSTR(
                                                            KEYS_A1, LENGTH(CONCAT(CONCAT(CONCAT(SA1, ' '), E_SA1), ';'))
                                                        )
