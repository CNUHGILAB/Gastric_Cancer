    ...
    FROM(
        ...
        FROM(
            SELECT *,
                ...
                CASE 
                    WHEN (NULLIF(BLOCK_ELSE3, '') IS NOT NULL AND NULLIF(`NONE_SLIDE_PARAFFIN_BLOCK(8)`, '') IS NULL)
                    THEN BLOCK_ELSE3
                    ELSE NULL
                END AS `NONE_KEY(9)`,
                CASE 
                ...
                FROM(
                    ...
                    FROM(
                        SELECT *,
                            ...
                            CASE 
                                WHEN NULLIF(BLOCK_ELSE2_1, '') IS NOT NULL
                                THEN BLOCK_ELSE2_1
                                /*
                            ...
                            CASE 
                                ...
                                */
                                ...
                                THEN BLOCK_ELSE2_1
                                */
                                WHEN REGEXP_INSTR(BLOCK_ELSE2_3, '(S|s)lide key') != 0
                                THEN BLOCK_ELSE2_3
                                ELSE NULL
                            ...
                            CASE 
                                ...
                                */
                                ...
                                THEN BLOCK_ELSE2_1
                                */
                                WHEN REGEXP_INSTR(BLOCK_ELSE2_3, '(P|p)araffin block key') != 0
                                THEN BLOCK_ELSE2_3
                                ELSE NULL
                        ...
                        FROM(
                            SELECT *,
                                CASE 
                                    WHEN (NULLIF(BLOCK_ELSE2_2, '') IS NOT NULL AND NULLIF(BLOCK_ELSE2_3, '') IS NULL)
                                    THEN BLOCK_ELSE2_2
                                    ELSE NULL
                                END AS BLOCK_ELSE3
                            FROM(
                                SELECT *,
                                    CASE
                                        WHEN REGEXP_INSTR(BLOCK_ELSE2_2, '(S|s)lide key') != 0
                                            OR REGEXP_INSTR(BLOCK_ELSE2_2, '(P|p)araffin block key') != 0
                                        THEN BLOCK_ELSE2_2
                                        /*
                                        WHEN (REGEXP_INSTR(BLOCK_ELSE2_2, '(S|s)lide key') != 0
                                        ...
                                        */
                                        ELSE NULL
                                    END AS BLOCK_ELSE2_3
                                FROM(
                                    SELECT *,
                                        CASE 
                                            WHEN (NULLIF(BLOCK_ELSE2, '') IS NOT NULL AND NULLIF(BLOCK_ELSE2_1, '') IS NULL)
                                            THEN BLOCK_ELSE2
                                            ELSE NULL
                                        END AS BLOCK_ELSE2_2
                                    FROM(
                                        SELECT *,
                                            ...
                                            CASE 
                                                ...
                                                */
                                                WHEN (REGEXP_INSTR(BLOCK_ELSE2, '[(]A[)]') != 0
                                                    OR REGEXP_INSTR(BLOCK_ELSE2, '[(]A(,|-)') != 0
