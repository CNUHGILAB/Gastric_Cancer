...
FROM(
    SELECT *,
        CASE
            ...
            THEN E_SA4_4
            WHEN (NULLIF(E_SA4_5, '') IS NOT NULL)
            THEN E_SA4_5
            WHEN (NULLIF(E_SA4_6, '') IS NOT NULL)
            THEN E_SA4_6
            WHEN (NULLIF(E_SA4_7, '') IS NOT NULL)
            THEN E_SA4_7
            ELSE NULL
        END AS E_SA4,
        CASE
            ...
            THEN SA4_4
            WHEN (NULLIF(SA4_5, '') IS NOT NULL)
            THEN SA4_5
            WHEN (NULLIF(SA4_6, '') IS NOT NULL)
            THEN SA4_6
            WHEN (NULLIF(SA4_7, '') IS NOT NULL)
            THEN SA4_7
            ELSE NULL
        END AS SA4
    FROM(
        SELECT *,
            CASE
                ...
                THEN SA4_1_2
                WHEN (NULLIF(SA4_1_3, '') IS NOT NULL)
                THEN SA4_1_3
                ELSE NULL
            END AS SA4_1,
            CASE
            ...
            END AS SA4_2,
            CASE
                WHEN (NULLIF(SA4_6_1, '') IS NOT NULL)
                THEN SA4_6_1
                WHEN (NULLIF(SA4_6_2, '') IS NOT NULL AND NULLIF(SA4_6_2_1, '') IS NULL)
                THEN SA4_6_2
                WHEN (NULLIF(SA4_6_2, '') IS NOT NULL AND NULLIF(SA4_6_2_1, '') IS NOT NULL)
                THEN SA4_6_2_1
                ELSE NULL
            END AS SA4_6
        FROM(
            SELECT *,
                CASE
                    ...
                    THEN E_SA4_1_2
                    WHEN (NULLIF(E_SA4_1_3, '') IS NOT NULL)
                    THEN E_SA4_1_3
                    ELSE NULL
                END AS E_SA4_1,
                CASE
                ...
                END AS E_SA4_2,
                CASE
                    WHEN (NULLIF(E_SA4_6_1, '') IS NOT NULL)
                    THEN E_SA4_6_1
                    WHEN (NULLIF(E_SA4_6_2, '') IS NOT NULL)
                    THEN E_SA4_6_2
                    ELSE NULL
                END AS E_SA4_6
            FROM(
                    ...
                    FROM(
                        ...
                        FROM(
                            SELECT *,
                                ...
                                END AS SA4_2_2_1,
                                CASE
                                    WHEN (NULLIF(SA4_6_2, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_6_4, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                    THEN CONCAT(
                                        CONCAT(
                                            SA4_6_2, ';'
                                        ), REGEXP_SUBSTR(SLIDE_KEYS_6_4, '[^;]+', 1, 2)
                                    )
                                    ELSE NULL
                                END AS SA4_6_2_1
                            FROM(
                                SELECT *,
                                    ...
                                    CASE
                                        WHEN (NULLIF(E_SA4_1_3, '') IS NOT NULL)
                                        THEN SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_1_4, '[^\n]+', 1, 1), REGEXP_INSTR(REGEXP_SUBSTR(SLIDE_KEYS_1_4, '[^\n]+', 1, 1), ' [A-Z]{1,2}[0-9]{1,3}'))
                                        ELSE NULL
                                    END AS SA4_1_3,
                                    CASE
                                        WHEN (NULLIF(E_SA4_2_1, '') IS NOT NULL)
                                    ...
                                    CASE
                                        WHEN (NULLIF(E_SA4_3, '') IS NOT NULL)
                                        THEN SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_4, '[^\n]+', 1, 1), INSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_4, '[^\n]+', 1, 1), REGEXP_SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_4, '[^\n]+', 1, 1), '[^;]+', 1, 2)))
                                        ELSE NULL
                                    END AS SA4_3,
                                    CASE
                                        WHEN (NULLIF(E_SA4_4, '') IS NOT NULL)
                                    ...
                                    CASE
                                        WHEN (NULLIF(E_SA4_5, '') IS NOT NULL)
                                        THEN SUBSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_5_4, '[^;]+', 1, 1), 1, REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_5_4, '[^;]+', 1, 1), ' [(]'))
                                        ELSE NULL
                                    END AS SA4_5,
                                    CASE
                                        WHEN (NULLIF(E_SA4_6_1, '') IS NOT NULL)
                                        THEN REGEXP_SUBSTR(SLIDE_KEYS_6_4, '[^;]+', 1, 1)
                                        ELSE NULL
                                    END AS SA4_6_1,
                                    CASE
                                        WHEN (NULLIF(E_SA4_6_2, '') IS NOT NULL)
                                    ...
                                    CASE
                                        WHEN (NULLIF(E_SA4_7, '') IS NOT NULL)
                                        THEN SUBSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_7_4, '[^;]+', 1, 1), 1, REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_7_4, '[^;]+', 1, 1), ' [(]'))
                                        ELSE NULL
                                    END AS SA4_7
                                FROM(
                                    SELECT *,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_1_4, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_4, '[^\n]+', 1, 1), '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_4, '[^\n]+', 1, 1), '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN REGEXP_SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_1_4, '[^\n]+', 1, 1), '[^;]+', 1, 1)
                                            ELSE NULL
                                        END AS E_SA4_1_1,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_1_4, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_4, '[^\n]+', 1, 1), '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_4, '[^\n]+', 1, 1), '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_4, '[^\n]+', 1, 1), '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN CONCAT(
                                                CONCAT(
                                        ...
                                        END AS E_SA4_1_2,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_1_4, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_4, '[^\n]+', 1, 1), ' [A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_1_4, '[^\n]+', 1, 1), 1, REGEXP_INSTR(REGEXP_SUBSTR(SLIDE_KEYS_1_4, '[^\n]+', 1, 1), '[A-Z]{1,2}[0-9]{1,3}'))
                                            ELSE NULL
                                        END AS E_SA4_1_3,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_2_4, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_2_4, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_2_4, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                        ...
                                        END AS E_SA4_2_1,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_2_4, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_2_4, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_2_4, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_2_4, '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN CONCAT(
                                                CONCAT(
                                                    REGEXP_SUBSTR(SLIDE_KEYS_2_4, '[^;]+', 1, 1), ';'
                                                ), REGEXP_SUBSTR(SLIDE_KEYS_2_4, '[^;]+', 1, 2)
                                            )
                                            WHEN (NULLIF(SLIDE_KEYS_2_4, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_2_4, '[^;]+', 1, 1), '^[A-Z][a-z][0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_2_4, '[^;]+', 1, 2), '^[A-Z][a-z][0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_2_4, '[^;]+', 1, 3), '^[A-Z][a-z][0-9]{1,3}') != 0)
                                            THEN CONCAT(
                                                CONCAT(
                                                    REGEXP_SUBSTR(SLIDE_KEYS_2_4, '[^;]+', 1, 1), ';'
                                                ), REGEXP_SUBSTR(SLIDE_KEYS_2_4, '[^;]+', 1, 2)
                                        ...
                                        END AS E_SA4_2_2,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_3_4, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_4, '[^\n]+', 1, 1), '[^;]+', 1, 1), '^[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_4, '[^\n]+', 1, 1), '[^;]+', 1, 2), '^[0-9]{1,3}') != 0)
                                            THEN REGEXP_SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_4, '[^\n]+', 1, 1), '[^;]+', 1, 1)
                                            WHEN (NULLIF(SLIDE_KEYS_3_4, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_3_4, '[^\n]+', 1, 1), '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_3_4, '[^\n]+', 1, 1), '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN REGEXP_SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_4, '[^\n]+', 1, 1), '[^;]+', 1, 1)
                                            ELSE NULL
                                        END AS E_SA4_3,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_4_4, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_4, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') != 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_4, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0)
                                            THEN REGEXP_SUBSTR(SLIDE_KEYS_4_4, '[^;]+', 1, 2)
                                            ELSE NULL
                                        END AS E_SA4_4,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_5_4, '') IS NOT NULL)
                                            THEN SUBSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_5_4, '[^;]+', 1, 1), REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_5_4, '[^;]+', 1, 1), '[(]'))
                                            ELSE NULL
                                        END AS E_SA4_5,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_6_4, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_6_4, '[^;]+', 1, 1), '^[0-9]{1,3}') != 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_6_4, '[^;]+', 1, 2), '^[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_6_4, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0)
                                            THEN REGEXP_SUBSTR(SLIDE_KEYS_6_4, '[^;]+', 1, 2)
                                            ELSE NULL
                                        END AS E_SA4_6_1,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_6_4, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_6_4, '[^;]+', 1, 1), '^[0-9]{1,3}') != 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_6_4, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') != 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_6_4, '[^;]+', 1, 3), '^[0-9]{1,3}') = 0)
                                            THEN REGEXP_SUBSTR(SLIDE_KEYS_6_4, '[^;]+', 1, 3)
                                            ELSE NULL
                                        END AS E_SA4_6_2,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_7_4, '') IS NOT NULL)
                                            THEN SUBSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_7_4, '[^;]+', 1, 1), REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_7_4, '[^;]+', 1, 1), '[(]'))
                                            ELSE NULL
                                        END AS E_SA4_7
                                    FROM(
                                        SELECT *,
                                            ...
                                            CASE
                                                WHEN (NULLIF(SLIDE_KEYS_A4, '') IS NOT NULL AND NULLIF(SLIDE_KEYS_5, '') IS NOT NULL)
                                                THEN SLIDE_KEYS_A4
                                                ELSE NULL
                                            END AS SLIDE_KEYS_5_4,
                                            CASE
                                                WHEN (NULLIF(SLIDE_KEYS_A4, '') IS NOT NULL AND NULLIF(SLIDE_KEYS_6, '') IS NOT NULL)
                                                THEN SLIDE_KEYS_A4
                                                ELSE NULL
                                            END AS SLIDE_KEYS_6_4,
                                            CASE
                                                WHEN (NULLIF(SLIDE_KEYS_A4, '') IS NOT NULL AND NULLIF(SLIDE_KEYS_7, '') IS NOT NULL)
                                                THEN SLIDE_KEYS_A4
                                                ELSE NULL
                                            END AS SLIDE_KEYS_7_4
                                        FROM(
                                            SELECT *,
                                                CASE
                                            ...
                                            FROM(
                                                SELECT *,
                                                    CASE
                                                        ...
                                                        WHEN (NULLIF(SA3, '') IS NOT NULL AND NULLIF(SLIDE_KEYS_5, '') IS NOT NULL)
                                                        THEN SUBSTR(
                                                            BINARY SLIDE_KEYS_A3, LENGTH(CONCAT(CONCAT(SA3, E_SA3), ';'))
                                                        )
                                                        WHEN (NULLIF(SA3, '') IS NOT NULL AND NULLIF(SLIDE_KEYS_6, '') IS NOT NULL)
                                                        THEN SUBSTR(
                                                            BINARY SLIDE_KEYS_A3, LENGTH(CONCAT(CONCAT(CONCAT(SA3, ';'), E_SA3), ';'))
                                                        )
                                                        WHEN (NULLIF(SA3, '') IS NOT NULL AND NULLIF(SLIDE_KEYS_7, '') IS NOT NULL)
                                                        THEN SUBSTR(
                                                            BINARY SLIDE_KEYS_A3, LENGTH(CONCAT(CONCAT(SA3, E_SA3), ';'))
                                                        )
                                                        ELSE NULL
                                                    END AS RE_SLIDE_KEYS
                                                FROM test_type6_sa03
                                            ) a
                                        ) a
                                    ) a
                                ) a
