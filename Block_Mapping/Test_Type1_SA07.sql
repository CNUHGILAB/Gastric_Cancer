...
FROM(
    ...
    FROM(
        SELECT *,
            ...
            END AS SA7_1,
            CASE
                WHEN (NULLIF(SA7_4_1, '') IS NOT NULL)
                THEN SA7_4_1
                WHEN (NULLIF(SA7_4_2, '') IS NOT NULL)
                THEN SA7_4_2
                ELSE NULL
            END AS SA7_4
        FROM(
                        ...
                        FROM(
                            ...
                            FROM(
                                SELECT *,
                                    ...
                                    CASE
                                        WHEN (NULLIF(E_SA7_3, '') IS NOT NULL)
                                        THEN SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_7, '[^;]+', 1, 1), 1, INSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_7, '[^;]+', 1, 1), ')'))
                                        ELSE NULL
                                    END AS SA7_3,
                                    CASE
                                        WHEN (NULLIF(E_SA7_4_1, '') IS NOT NULL)
                                ...
                                FROM(
                                    SELECT *,
                                        ...
                                        END AS E_SA7_1_1,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_1_7, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_7, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_7, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_1_7, '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN CONCAT(
                                                CONCAT(
                                        ...
                                        END AS E_SA7_1_2,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_2_7, '') IS NOT NULL)
                                            THEN REGEXP_SUBSTR(SLIDE_KEYS_2_7, '[^;]+', 1, 2)
                                            ELSE NULL
                                        END AS E_SA7_2,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_3_7, '') IS NOT NULL AND NULLIF(REGEXP_SUBSTR(SLIDE_KEYS_3_7, '[^;]+', 1, 1), '') IS NOT NULL)
                                            THEN SUBSTR(REGEXP_SUBSTR(SLIDE_KEYS_3_7, '[^;]+', 1, 1), REGEXP_INSTR(BINARY REGEXP_SUBSTR(SLIDE_KEYS_3_7, '[^;]+', 1, 1), '[a-z]+'))
                                            ELSE NULL
                                        END AS E_SA7_3,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_4_7, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') != 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]+', 1, 2)
                                            WHEN (NULLIF(SLIDE_KEYS_4_7, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') != 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]+', 1, 3) = REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]*$'))
                                            THEN REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]+', 1, 2)
                                            WHEN (NULLIF(SLIDE_KEYS_4_7, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') != 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]+', 1, 2) = REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]*$'))
                                            THEN REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]+', 1, 2)
                                            ELSE NULL
                                        END AS E_SA7_4_1,
                                        CASE
                                            WHEN (NULLIF(SLIDE_KEYS_4_7, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') != 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 4), '^[A-Z]{1,2}[0-9]{1,3}') != 0)
                                            THEN CONCAT(
                                                CONCAT(
                                                    REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]+', 1, 2), ';'
                                                ), REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]+', 1, 3)
                                            )
                                            WHEN (NULLIF(SLIDE_KEYS_4_7, '') IS NOT NULL AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 1), '^[A-Z]{1,2}[0-9]{1,3}') != 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 2), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_INSTR(REGEXP_SUBSTR(BINARY SLIDE_KEYS_4_7, '[^;]+', 1, 3), '^[A-Z]{1,2}[0-9]{1,3}') = 0 AND REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]+', 1, 3) = REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]*$'))
                                            THEN CONCAT(
                                                CONCAT(
                                                    REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]+', 1, 2), ';'
                                                ), REGEXP_SUBSTR(SLIDE_KEYS_4_7, '[^;]+', 1, 3)
                                        ...
                                        END AS E_SA7_4_2,
                                        CASE
                                            WHEN (NULLIF(PARAFFIN_BLOCK_KEYS_1_7, '') IS NOT NULL)
                                    ...
                                    FROM(
                                        SELECT *,
                                            ...
                                            CASE
                                                WHEN (NULLIF(KEYS_A7, '') IS NOT NULL AND NULLIF(SLIDE_KEYS_2, '') IS NOT NULL)
                                                THEN KEYS_A7
                                                ELSE NULL
                                            END AS SLIDE_KEYS_2_7,
                                            CASE
                                                WHEN (NULLIF(KEYS_A7, '') IS NOT NULL AND NULLIF(SLIDE_KEYS_3, '') IS NOT NULL)
                                                THEN KEYS_A7
                                                ELSE NULL
                                            END AS SLIDE_KEYS_3_7,
                                            CASE
                                                WHEN (NULLIF(KEYS_A7, '') IS NOT NULL AND NULLIF(SLIDE_KEYS_4, '') IS NOT NULL)
                                                THEN KEYS_A7
                                                ELSE NULL
                                            ...
                                            FROM(
                                                SELECT *,
                                                    CASE
                                                        ...
                                                        THEN SUBSTR(
                                                            KEYS_A6, LENGTH(CONCAT(CONCAT(CONCAT(SA6, ' '), E_SA6), ';'))
                                                        )
