...
class RegistryMerge10(BaseETL):
    ...
    def run(self):
        ...
        df.to_excel('D:/Gastric_Cancer_xlsx/Registry(2012-2022)/Registry_Merge_10.xlsx')
        #print(df)
        
        self.insert(df, db_name = "registry_protocol", tb_name = "registry_merge_10")
