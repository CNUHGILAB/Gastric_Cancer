...
class TbTmpComorbidityStep10_04(BaseETL):
    ...
    def run(
        ...
        SELECT
            ...
            st1.HF
        FROM
            gc_protocol.tb_tmp_comorbidity_step_10_03 st0
            LEFT JOIN gc_protocol.tb_tmp_comorbidity_step_10_02 st1 ON st0.ID = st1.ID
            OR (
        ...
        FROM
            gc_protocol.tb_tmp_comorbidity_step_10_03 st0
            RIGHT JOIN gc_protocol.tb_tmp_comorbidity_step_10_02 st1 ON st0.ID = st1.ID
            OR (
                st0.Heart_disease_Date = st1.HF_Date
                AND st0.Heart_disease_MD_1 = st1.HF_MD_1
                AND st0.Heart_disease_MD_2 = st1.HF_MD_2
        ...
        FROM
            gc_protocol.tb_tmp_comorbidity_step_10_03 st0
            INNER JOIN gc_protocol.tb_tmp_comorbidity_step_10_02 st1 ON st0.ID = st1.ID
            OR (
                st0.Heart_disease_Date = st1.HF_Date
                AND st0.Heart_disease_MD_1 = st1.HF_MD_1
                AND st0.Heart_disease_MD_2 = st1.HF_MD_2
        ...
        print(df)
        self.insert(df, db_name="gc_protocol", tb_name="tb_tmp_comorbidity_step_10_04")
