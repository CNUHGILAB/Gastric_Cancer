...
class TbTmpComorbidityStep09(BaseETL):
    ...
    def run(
        ...
        sql = "SELECT ID FROM gc_protocol.tb_tmp_comorbidity_step_08;"
            ...
            sql = '''
                ...
                FROM
                    ...
                    FROM
                        ...
                        FROM
                            gc_protocol.tb_tmp_comorbidity_step_08
                        WHERE
                            ID = '{0}')a, 
                        (SELECT 
                            *
        ...
        self.insert(df2, db_name="gc_protocol", tb_name="tb_tmp_comorbidity_step_09") 
