    ...
    def run(self):
        ...
        sql01 = '''
            SELECT
                ...
                Stomach_Polyp_Bx,
                CONCAT(Stomach_Ulcer_Size_1, Stomach_Ulcer_Size_2) AS Stomach_Ulcer_Size,
                Stomach_Ulcer_BGU,
                Stomach_Ulcer_Bx,
