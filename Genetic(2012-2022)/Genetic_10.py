...
class Genetic10(BaseETL):
    ...
    def run(self):
        ...
        Data_S_100.rename(columns = {0: '원무접수ID', 1: 'S-100', 2: 'S-100_1', 3: 'S-100_2'}, inplace = True)
        
        #print(Data_S_100)
        
        self.insert(Data_S_100, db_name = 'genetic_protocol', tb_name = 'genetic_10')

        f = open('Genetic(2012-2022)/Genetic_10(S-100).sql', 'rt', encoding = 'UTF8')
        ...
        df = self.df_from_sql(db_name = 'genetic_protocol', sql = sql)
        df.to_excel('D:/Gastric_Cancer_xlsx/Genetic(2012-2022)/Genetic_10(S-100).xlsx')
