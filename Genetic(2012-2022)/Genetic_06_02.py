    ...
    def run(self):
        ...
        for i in range(0, x):
            ...
            for word in list_void:
                ...
                if 'cd31' in word_low:
                    CD31[i].append(word)
                    if 'cd31 and d2-40' and 'd2-40 and cd31' and 'cd31 & d2-40' and 'cd31 & d240' and 'd2-40, cd31' in word_low:
                        CD31[i].remove(word)
        ...
        self.insert(Data_CD31, db_name = 'genetic_protocol', tb_name = 'genetic_06_02')

        f = open('Genetic_Test/Genetic_06_02(CD31).sql', 'rt', encoding = 'UTF8')
