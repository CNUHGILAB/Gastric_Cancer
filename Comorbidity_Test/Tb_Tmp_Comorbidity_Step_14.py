...
class TbTmpComorbidityStep14(BaseETL):
    ...
    def run(
        ...
        sql = "SELECT ID FROM gc_protocol_test.tb_tmp_comorbidity_13;"
            ...
            sql = '''
                ...
                FROM
                    ...
                    FROM
                        ...
                        FROM
                            gc_protocol_test.tb_tmp_comorbidity_13
                        WHERE
                            ID = '{0}')a, 
                        (SELECT 
                            *
        ...
        self.insert(df2, db_name="gc_protocol_test", tb_name="tb_tmp_comorbidity_14") 
