...
class TbTmpComorbidityStep04(BaseETL):
    ...
    def run(
        ...
        for x in o_ID:
            f = open("Comorbidity_Test/HTN.txt",'rt',encoding='UTF8')
            sql= ''
            while True:
                line = f.readline()
                if not line: break
        ...
        self.insert(df, db_name="gc_protocol_test", tb_name="tb_tmp_comorbidity_04_00")

if __name__ == "__main__":
    obj = TbTmpComorbidityStep04()
    obj.run()