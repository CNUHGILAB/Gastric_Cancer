...
class Comorbidity06(BaseETL):
    ...
    def run(self):
        ...
        for x in o_ID:
            ...
            f = open("Comorbidity_Test/Comorbidity_06(L_Hep).txt", 'rt', encoding = 'UTF8')
        ...
        self.insert(df, db_name = "gc_protocol_test", tb_name = "comorbidity_06") # tb_name = "tb_tmp_comorbidity_06_00"
