    ...
    def run(self):
        ...
        sql = '''
            SELECT
                ...
                EBV,
                Giemsa
            FROM genetic_merge_12 st0
                LEFT JOIN genetic_15_02 st1 ON (
                    st0.환자번호 = st1.환자번호
        ...
        df.to_excel('D:/Gastric_Cancer_xlsx/Genetic(2012-2022)/Genetic.xlsx')
        
        self.insert(df, db_name = "gc_database_total", tb_name = "genetic")
        self.insert(df, db_name = "genetic_total", tb_name = "genetic_merge_13")
